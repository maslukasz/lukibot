...
async def leveling(event: hikari.Event) -> None:
    ...
    if lvl_end == 5:
           await user_plugin.bot.rest.add_role_to_member(event.guild.get_role(630489950009294897))
           level_up_msg = f"""🎉 Gratulacje <@{event.message.author.id}>! Właśine udało Ci się zdobyć **{lvl_end}** poziom. Oby tak dalej!
:mirror_ball: Otrzymujesz <@&630489950009294897>!"""

    if lvl_end == 10:
        await user_plugin.bot.rest.add_role_to_member(event.guild.get_role(630489979734327323))
        await user_plugin.bot.rest.remove_role_from_member(event.guild.get_role(630489979734327323))
        level_up_msg = f"""🎉 Gratulacje <@{event.message.author.id}>! Właśine udało Ci się zdobyć **{lvl_end}** poziom. Oby tak dalej!
:mirror_ball: Otrzymujesz <@&630489979734327323>!
:wastebasket: Zabieram <@&630489979734327323>"""

    if lvl_end == 15:
        await user_plugin.bot.rest.add_role_to_member(event.guild.get_role(630490054321635368))
        await user_plugin.bot.rest.remove_role_from_member(event.guild.get_role(630490054321635368))
        level_up_msg = f"""🎉 Gratulacje <@{event.message.author.id}>! Właśine udało Ci się zdobyć **{lvl_end}** poziom. Oby tak dalej!
:mirror_ball: Otrzymujesz <@&630490054321635368>!
:wastebasket: Zabieram <@&630490054321635368>"""
    
    if lvl_end == 20:
         await user_plugin.bot.rest.add_role_to_member(event.guild.get_role(724323821313589290))
         await user_plugin.bot.rest.remove_role_from_member(event.guild.get_role(724323821313589290))
         level_up_msg = f"""🎉 Gratulacje <@{event.message.author.id}>! Właśine udało Ci się zdobyć **{lvl_end}** poziom. Oby tak dalej!
:mirror_ball: Otrzymujesz <@&724323821313589290>!
:wastebasket: Zabieram <@&724323821313589290>"""
    
    if lvl_end == 25:
         await user_plugin.bot.rest.add_role_to_member(event.guild.get_role(688363696602349579))
         await user_plugin.bot.rest.remove_role_from_member(event.guild.get_role(688363696602349579))
         level_up_msg = f"""🎉 Gratulacje <@{event.message.author.id}>! Właśine udało Ci się zdobyć **{lvl_end}** poziom. Oby tak dalej!
:mirror_ball: Otrzymujesz <@&688363696602349579>!
:wastebasket: Zabieram <@&688363696602349579>"""

    if lvl_end == 30:
         await user_plugin.bot.rest.add_role_to_member(event.guild.get_role(688363696291971146))
         await user_plugin.bot.rest.remove_role_from_member(event.guild.get_role(688363696291971146))
         level_up_msg = f"""🎉 Gratulacje <@{event.message.author.id}>! Właśine udało Ci się zdobyć **{lvl_end}** poziom. Oby tak dalej!
:mirror_ball: Otrzymujesz <@&688363696291971146>!
:wastebasket: Zabieram <@&688363696602349579>"""

    if lvl_end == 35:
         await user_plugin.bot.rest.add_role_to_member(event.guild.get_role(688363695461629981))
         await user_plugin.bot.rest.remove_role_from_member(event.guild.get_role(688363695461629981))
         level_up_msg = f"""🎉 Gratulacje <@{event.message.author.id}>! Właśine udało Ci się zdobyć **{lvl_end}** poziom. Oby tak dalej!
...
:wastebasket: Zabieram <@&688363695461629981>"""
    ...
    if lvl_end == 45:
         await user_plugin.bot.rest.add_role_to_member(event.guild.get_role(688363695109046295))
         await user_plugin.bot.rest.remove_role_from_member(event.guild.get_role(688363695109046295))
         level_up_msg = f"""🎉 Gratulacje <@{event.message.author.id}>! Właśine udało Ci się zdobyć **{lvl_end}** poziom. Oby tak dalej!
:mirror_ball: Otrzymujesz <@&688363695109046295>!
:wastebasket: Zabieram <@&688363695461629981>"""

    if lvl_end == 50:
         await user_plugin.bot.rest.add_role_to_member(event.guild.get_role(688363695042199552))
         await user_plugin.bot.rest.remove_role_from_member(event.guild.get_role(688363695042199552))
         level_up_msg = f"""🎉 Gratulacje <@{event.message.author.id}>! Właśine udało Ci się zdobyć **{lvl_end}** poziom. Oby tak dalej!
